...
export default function () {
    ...
    return <BottomStack.Navigator
        ...
        tabBar={({ navigation }) => {
            return <Box w="100%" m={0} px={0} py={2} h={60} shadow={1} background="white">
                <HStack flex="1" w="100%">
                    <Pressable flex={1} onPress={() => navigation.navigate("Dashboard")}>
                        {({
                            isPressed
                            ...
                            transform: [{
                                ...
                                <Icon as={FontAwesome} name="home" size="xl" color="primary.900" />
                                <Text fontSize={"xs"}>Inicio</Text>
                            </VStack>}
                    </Pressable>
                    <Pressable flex={1} onPress={() => navigation.navigate("Inversiones")}>
                        {({
                            isPressed
                        }) => <VStack flex="1" alignItems="center" style={{
                            transform: [{
                    ...
                    <Pressable flex={1} onPress={() => navigation.navigate("Settings")}>
                        {({
                            ...
                            transform: [{
                                ...
                                <Icon as={Octicons} name="gear" size="xl" color="primary.900" />
                                <Text fontSize={"xs"}>Ajustes</Text>
                            </VStack>}
                    </Pressable>
                </HStack>
            </Box>
