                        ...
                        <Box mr={6}>
                            ...
                            <Text>
                                <Text align="justify">
                                    ...
                                    {user.nombres ?? user?.nombre} {user?.apellido_paterno} {user?.apellido_materno}, a quien por razón del mismo se le denominará como "EL INVERSIONISTA", que en este momento adquiere para si, la cantidad de {plantas} {plantas_texto} PLANTAS DE AGAVE AZUL TEQUILANA WEBER, cada una de ellas por la cantidad de
                                    <Text>${precio_planta}
                                ...
                                <Text>
                                    ...
                                    en su calidad de “EL PRODUCTOR Y PROPIETARIO”, como el señor {user.nombres ?? user?.nombre} {user?.apellido_paterno} {user?.apellido_materno} a quien por razón del mismo se le denominará
                                ...
                                <Text>
                                    = = CUARTA.- Al llegar a la venta final de las plantas, corresponderá el 65% (sesenta y cinco por ciento) a favor del señor (a) {user.nombres ?? user?.nombre} {user?.apellido_paterno} {user?.apellido_materno}, a quien por razón del mismo se le denominará como "EL INVERSIONISTA”, y el 35% (TREINTA Y CINCO POR CIENTO) a ZEUS ORO AZUL DE LOS ALTOS, S de PR de RL de CV, en su calidad de "EL PRODUCTOR Y PROPIETARIO", así mismo convienen ambas partes, que si fuere el caso de que en el momento de la venta del agave en su rendimiento ya jimado a un tercero, existan leyes que establezcan el pago de algún impuesto fiscal, dicho impuesto será cubierto por cada parte, según su ganancia obtenida.
                                </Text>
                                <Text>
                                ...
                                <Text>
                                    = = SEXTA.- Convienen ZEUS ORO AZUL DE LOS ALTOS, S de PR de RL de CV, en su calidad de “EL PRODUCTOR Y PROPIETARIO”, como el señor (a) {user.nombres ?? user?.nombre} {user?.apellido_paterno} {user?.apellido_materno}, "EL INVERSIONISTA”, que para que las plantas de agave materia de la presente inversión lleguen a su madurez para la jima y el acarreo final se estipula como plazo el tiempo de 4 cuatro a 7 siete años a partir de que sean plantadas.
                                </Text>
                                <Text>
